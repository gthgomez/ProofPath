 ...
 * embedded script generated by `createNativeWebViewRunnerHtml` mirrors the gate
 * inline, and the web runtime calls `isTrustedSqlHarness` directly. Tests use
 * this alias to prove the native and web predicates stay identical.
 */
