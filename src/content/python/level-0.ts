...
export const level0Lessons: Lesson[] = [
  proofLesson({
    ...
    synopsis: "Where does main.py live and how does Python find it?",
  ...
  proofLesson({
    ...
    synopsis: "How do you talk to your computer without clicking anything?",
  ...
  proofLesson({
    ...
    synopsis: "You typed python hello.py and something happened. What actually ran?",
  ...
  proofLesson({
    ...
    synopsis: "What's the fastest way to see if your code change worked?",
  ...
  proofLesson({
    ...
    synopsis: "Your code just broke. Where do you even start looking?",
...
level0Lessons[0].depth = {
  ...
  codeLabBridge: {
    ...
    learnerOwns: ["path", "project", "main"],
    checkerOwns: ["extension-identified"],
    runExpectation: "py"
  },
...
level0Lessons[1].depth = {
  ...
  codeLabBridge: {
    ...
    learnerOwns: ["command"],
    checkerOwns: ["terminal-command-executed"],
